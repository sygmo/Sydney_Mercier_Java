...
public class GameControllerTest {
    ...
    @MockBean
    private GamestoreCatalogServiceLayer catalogServiceLayer;
    ...
    public void shouldCreateGame() throws Exception{
        ...
        when(catalogServiceLayer.createGame(inGameViewModel)).thenReturn(savedGameViewModel);
    ...
    public void shouldReturnGameInfo() throws Exception{
        ...
        // same as doReturn(gameViewModel).when(catalogServiceLayer).getGame(8);
        // We could also set up our mocks in a separate method, if we so chose
        when(catalogServiceLayer.getGame(8)).thenReturn(gameViewModel);
    ...
    public void shouldFailGetGameBadIdReturns404() throws Exception {
        ...
        GameViewModel gameViewModel = new GameViewModel();
        outputJson = mapper.writeValueAsString(gameViewModel);
        when(catalogServiceLayer.getGame(idForGameThatDoesNotExist)).thenReturn(null);
    ...
    public void shouldUpdateGame() throws Exception{
        ...
        doNothing().when(catalogServiceLayer).updateGame(inGameViewModel);
    ...
    public void shouldDeleteGame() throws Exception{
        ...
        //Nothing to mock!
        //Checking checking for the correct response status code
        doNothing().when(catalogServiceLayer).deleteGame(62);
    ...
    public void shouldGetGamesByTitle() throws Exception{
        ...
        //Mock call to service layer...
        when(catalogServiceLayer.getGameByTitle("Halo")).thenReturn(foundList);
        ...
        //Mock call to service layer...
        when(catalogServiceLayer.getGameByTitle("not there")).thenReturn(null);
    ...
    public void shouldGetGamesByEsrbRating() throws Exception{
        ...
        //Mock call to service layer...
        when(catalogServiceLayer.getGameByEsrb("10+")).thenReturn(foundList);
        ...
        //Mock call to service layer...
        when(catalogServiceLayer.getGameByEsrb("not there")).thenReturn(null);
    ...
    public void shouldGetGamesByStudio() throws Exception{
        ...
        //Mock call to service layer...
        when(catalogServiceLayer.getGameByStudio("A&E")).thenReturn(foundList);
        ...
        //Mock call to service layer...
        when(catalogServiceLayer.getGameByStudio("not there")).thenReturn(null);
    ...
    public void shouldGetAllGames() throws Exception{
        ...
        //Mock call to service layer...
        when(catalogServiceLayer.getAllGames()).thenReturn(foundList);
        ...
        //Mock call to service layer...
        when(catalogServiceLayer.getAllGames()).thenReturn(null);
    ...
    public void shouldFailCreateGameWithInvalidData() throws Exception {
        ...
        when(this.catalogServiceLayer.createGame(inGameViewModel)).thenReturn(null);
    ...
    public void shouldFailFindGamesWithInvalidData() throws Exception {
        ...
        //So we are mocking (not executing the service layer) since we are testing the controller here.
        // Remember: we are testing the code of the CONTROLLER methods.
        when(this.catalogServiceLayer.getGame(77)).thenReturn(null);
        ...
        //So we are mocking (not executing the service layer) since we are testing the controller here.
        // Remember: we are testing the code of the CONTROLLER methods.
        when(this.catalogServiceLayer.getGameByStudio(badValue)).thenReturn(null);
        ...
        when(this.catalogServiceLayer.getGameByEsrb(badValue)).thenReturn(null);
        ...
        when(this.catalogServiceLayer.getGameByTitle(badValue)).thenReturn(null);
