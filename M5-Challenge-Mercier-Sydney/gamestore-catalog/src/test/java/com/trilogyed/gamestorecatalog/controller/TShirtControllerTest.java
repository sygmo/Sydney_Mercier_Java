...
public class TShirtControllerTest {
    ...
    public void shouldCreateTShirt() throws Exception{
        ...
        when(catalogServiceLayer.createTShirt(inTShirtViewModel)).thenReturn(savedTShirtViewModel);
    ...
    public void shouldReturnTShirtInfo() throws Exception{
        ...
        when(catalogServiceLayer.getTShirt(51)).thenReturn(savedTShirtViewModel);
    ...
    public void shouldUpdateTShirt() throws Exception{
        ...
        doNothing().when(catalogServiceLayer).updateTShirt(inTShirtViewModel);
    ...
    public void shouldDeleteTShirt() throws Exception{
        ...
        //Nothing to mock!
        //Checking checking for the correct response status code
        doNothing().when(catalogServiceLayer).deleteTShirt(51);
    ...
    public void shouldGetTShirtByColor() throws Exception{
        ...
        //Mock call to service layer...
        when(catalogServiceLayer.getTShirtByColor("SkyBlue")).thenReturn(foundList);
        ...
        //Mock call to service layer...
        when(catalogServiceLayer.getTShirtByColor("non-existent color")).thenReturn(null);
    ...
    public void shouldGetTShirtBySize() throws Exception{
        ...
        //Mock call to service layer...
        when(catalogServiceLayer.getTShirtBySize("S")).thenReturn(foundList);
        ...
        //Mock call to service layer...
        when(catalogServiceLayer.getTShirtBySize("XL")).thenReturn(null);
    ...
    public void shouldGetAllTShirt() throws Exception{
        ...
        //Mock call to service layer...
        when(catalogServiceLayer.getAllTShirts()).thenReturn(foundList);
        ...
        //Mock call to service layer...
        when(catalogServiceLayer.getAllTShirts()).thenReturn(null);
    ...
    public void shouldFailCreateTShirtWithBadData() throws Exception{
        ...
        //Mock call to service layer...
        when(catalogServiceLayer.createTShirt(inTShirtViewModel)).thenReturn(null);
