...
public class GamestoreInvoicingServiceLayer {
    ...
    @Autowired
    public GamestoreInvoicingServiceLayer(InvoiceRepository invoiceRepo, TaxRepository taxRepo,
                                          ProcessingFeeRepository processingFeeRepo, GamestoreCatalog catalog) {
    ...
    public InvoiceViewModel createInvoice(InvoiceViewModel invoiceViewModel) {
        ...
        if (invoiceViewModel.getItemType().equals(CONSOLE_ITEM_TYPE)) {
            Console returnVal = catalog.getConsoleById(invoiceViewModel.getItemId());
            ...
            Game returnVal = catalog.getGameById(invoiceViewModel.getItemId());
            ...
            TShirt returnVal = catalog.getTShirtById(invoiceViewModel.getItemId());
