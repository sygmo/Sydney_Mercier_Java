...
public class InvoiceControllerTest {
    ...
    @MockBean
    private GamestoreInvoicingServiceLayer invoicingServiceLayer;
    ...
    public void shouldAddPurchase() throws Exception{
        ...
        when(invoicingServiceLayer.createInvoice(inInvoice)).thenReturn(savedInvoice);
    ...
    public void shouldFindInvoice() throws Exception{
        ...
        //Mock call to service layer...
        when(invoicingServiceLayer.getInvoice(22)).thenReturn(savedInvoice);
        ...
        //Mock call to service layer...
        when(invoicingServiceLayer.getInvoice(-1)).thenReturn(null);
    ...
    public void shouldFindAllInvoices() throws Exception{
        ...
        //Mock call to service layer...
        when(invoicingServiceLayer.getAllInvoices()).thenReturn(foundAllInvoices);
        ...
        //Mock call to service layer...
        when(invoicingServiceLayer.getAllInvoices()).thenReturn(null);
    ...
    public void shouldFindInvoicesByCustomerName() throws Exception{
        ...
        //Mock call to service layer...
        when(invoicingServiceLayer.getInvoicesByCustomerName("Sandy Beach")).thenReturn(foundAllInvoices);
        ...
        //Mock call to service layer...
        when(invoicingServiceLayer.getInvoicesByCustomerName("no customer")).thenReturn(null);
    ...
    public void shouldFailCreateUnvoiceWithBadData() throws Exception{
        ...
        when(this.invoicingServiceLayer.createInvoice(inInvoiceMV)).thenReturn(null);
